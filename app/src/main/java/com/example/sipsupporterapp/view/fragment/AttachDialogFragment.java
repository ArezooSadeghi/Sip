...
public class AttachDialogFragment extends DialogFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        viewModel.getAttachResultSingleLiveEvent().observe(this, new Observer<AttachResult>() {
            ...
            public void onChanged(AttachResult attachResult) {
                ...
                AttachSuccessfulDialogFragment fragment = AttachSuccessfulDialogFragment.newInstance();
                fragment.show(getParentFragmentManager(), AttachSuccessfulDialogFragment.TAG);
            }
        });
                ...
                case SELECT_PICTURE_REQUEST_CODE:
                    if (data.getData() != null) {
                       ...
                       *//* try {
                            ...
                            fileData = Base64.encodeToString(inputData, Base64.DEFAULT);
                            File file = new File(uri.getPath());
                            fileName = file.getName();
    ...
    private void setListener() {
        ...
        binding.extendedFabAttach.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Log.d("Arezoo", "extendedAttach");
